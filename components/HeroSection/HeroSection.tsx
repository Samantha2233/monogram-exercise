...
export function HeroSection() {
    return (
        <section className="flex flex-col-reverse items-center justify-end p-[10px] text-center lg:flex-row lg:p-0 lg:text-left lg:items-start lg:justify-center">
            <div>
                <h1 className="
                    animate-fadeInFromBottom fill-mode-both
                    p-0 text-[60px] lg:pt-[126px] lg:pl-[126px] lg:text-xl 
                ">
                    jamstack
                    <span className=" 
                ...
                <p className="
                    ...
                    p-0 text-[#757575] max-w-[675px] tracking-[.005em] leading-[195.5%] text-[18px] lg:pl-[178px] lg:pt-[44px]
                ">
