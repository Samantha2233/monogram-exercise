        ...
        <section  className='bg-[#151515] relative h-[180vh] xl:h-[170vh] min-[1400px]:h-[140vh] ' id='audit-section'> 
            <div className={styles.greenBox}>
                <div className="flex flex-col items-center relative h-[100vh]">
                    <h1 className='text-[#EFFFE2] text-[60px] text-center pt-[50px] md:pt-[100px] tracking-[-0.039em] leading-[65px] lg:pb-[30px] lg:text-[76px]'>top audit scores</h1>
                    {/* Score Circle Meters */}
                    {isShowing ? (
                    ...
                    <p className="px-[20px] py-[25px] text-[#C7C7C7] text-[18px] mix-blend-color-dodge max-w-[790px]  leading-[162%] sm:px-[30px] md:text-[26px]  pt-[50px]">
                    ...
                    <p className="px-[20px] py-[25px] text-[#C7C7C7] text-[18px] mix-blend-color-dodge max-w-[790px]  leading-[162%] sm:px-[30px] md:text-[26px] ">
